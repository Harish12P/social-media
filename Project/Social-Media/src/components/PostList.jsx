...
const PostList = () => {
  ...
  const [fetching, setFetching] = useState(false); //this state is loading
  useEffect(() => {
    setFetching(true); //loading
    ...
    fetch("https://dummyjson.com/posts", { signal })
      ...
      .then((data) => {
        ...
        setFetching(false); //loading
      });
    //like me homme pe hu or jana hai create post to console me ye show ho jaaaega
    //this return code is cleanup this use for timer disable
    return () => {
